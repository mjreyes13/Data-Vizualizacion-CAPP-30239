...
*Only after these can we start focusing on data and presentation.*
...
![bg fit](stunning-3d-chart.jpg)

---

![bg fit](datavizproject.png)
...
<div class="col">
  <ul>
  <li>US audiences associated <span style="color:red;">red</span> & <span style="color:blue">blue</span> with political parties on any map in a political context.
  <li>Also international meaning of <span style="color:red;">red</span> & <span style="color:blue;">blue</span> is flipped: <span style="color:red">red is left</span>, <span style="color:blue">blue is right</span>.
  <li>Most colors can have contradictory meanings depending on culture. For example, yellow might be chosen to denote success (parts of Africa) or be associated with death (Middle East).
  </ul>
</div>

<div class="col">

![width: 600px](hok-uk.svg)

<small>image from wikipedia: UK House of Commons</small>
</div>
</div>
...
- Achromatopsia: rarest, complete lack of color vision, usually present with other vision issues
...
![bg right fit](cmyk.svg)

Ink absorbs light, so we work with **subtractive blending**.

Our base colors are cyan, magenta, and yellow.  To save on ink costs, we throw in black/contrast as well.
...
**HSL**: **H**ue, **S**aturation, **L**ightness -  <https://hslpicker.com>
...
A perceptual color space like CIE, focused on human-readability & ease of creation of color schemes.
Also supports "wide gamut" (larger than sRGB) colors.

Added to most browsers in 2023-2024, tool support still spotty.
...
Projectors (like the one you're likely viewing this on) usually have fairly skewed gamut. 
...
Using HSL or OKLCH to build a palette allows you to choose uniform brightness/saturation and pick hues as close together/far apart as needed.
...
- **Layer** - Overlay different information while keeping contrast.
  ...
  - some alpha/translucency, but ensure legibility
...
Use proven schemes or use color theory (equal spacing of hue or saturation, etc.) to create your own.
