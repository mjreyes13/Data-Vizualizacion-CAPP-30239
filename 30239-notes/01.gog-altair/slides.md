...
## Learning Altair (or any library)

1. Learn the key concepts.
    - Goal: Understand how the authors of Altair think about visualization. Be able to map problems to that model.
...
3. Mastery (not always needed, definitely not this quarter!)
