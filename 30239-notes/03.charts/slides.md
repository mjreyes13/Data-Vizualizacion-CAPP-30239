...
**There are only 22,000 total spinal cord injuries a year in America (and most are 16-30yo).**

**.0000003%**

---

3. Write out explanation of the data on the graphic itself if needed.
...
Related: Deflated & standardized units of money are almost almost superior to nominal units.
...
When using Altair (or any grammar-of-graphics approach), proper selection of types & encodings will drastically narrow your options for you.
