...
### OK, there is a lot of data, and it is more granular than ever, *but isn't that a good thing*?
...
How can we amplify cognition?

- Develop intuition.
- Cope with large amounts of data.
- Try to comprehend **scale** and **correlation**.

When do you seek out a visualization?
...
- Practice getting & receiving critique.
...
Key Idea: You get better at visualizations by making *a lot* of them.

- Expect to write code every week, and read documentation.
...
D3 is an **option** for final project, not required.
...
- **Small assignments** - Practice exercises, graded on effort.
- **Projects**: One static, one dynamic. Each will go through a revision process with peer review.
     -  Leave here with a portfolio you can show off.
