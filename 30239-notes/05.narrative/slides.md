...
- Infographic
- Live Presentation (Powerpoint)
- Video / Animation
- Museum / In Person Interaction
- Web Interactives

How do these affect your message?
...
- **Markdown** - Simplified markup language that can be converted to HTML or PDF with various tools. Offers minimal control over formatting than other options.
